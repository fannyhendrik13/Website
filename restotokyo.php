...
<html>
 ...
 <body>
    <div class="header">
        <div class="jarak">
            <h2>Halal Restaurant In Tokyo</h2>
        </div>
    </div>
    <div class="menu">
        <ul>
                ...
                <div class="search-box">
                    ...
                    <?php 
                        ...
                        if(isset($_GET['search_name'])){
                            $tokyo_data = search(1, $search_name, $conn);
                        }else{
                            $tokyo_data = select_q(1, $conn);		
                        }
                        ?>
                </div>
    </div>
            ...
            <div class="jarak">
                ...
                <div class="kiri">
                    ...
                    <div class="border">
                        <div class="jarak">
                            <?php 
                                $rows1 = count($tokyo_data); // Number of rows in the array
                                for ($i = 0; $i < $rows1; $i++) {
                                    $columns = count($tokyo_data[$i]); // Number of columns in each row
                                    echo "<h3>".$tokyo_data[$i][2]."</h3>";
                                    echo "<p>Contact ".$tokyo_data[$i][3]."</p>";
                                    echo "<p>Address ".$tokyo_data[$i][4]."</p>";
                                    echo "<iframe src='".$tokyo_data[$i][5]."' width='200' height='200' style='border:0;' allowfullscreen='' loading='lazy' referrerpolicy='no-referrer-when-downgrade'></iframe>";
                                }
                            ?>
                        </div>
                    </div>
